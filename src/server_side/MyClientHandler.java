	...
	public void handleClient(InputStream input, OutputStream output) {
		...
		try {
			while(true) {
				...
				int entryRow = Integer.parseInt(entryLocation[1]);
				int entryCol = Integer.parseInt(entryLocation[0]);
				...
				int exitRow = Integer.parseInt(exitLocation[1]);
				int exitCol = Integer.parseInt(exitLocation[0]);
